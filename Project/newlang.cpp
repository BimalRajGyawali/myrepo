...
int main(int argc,char *args[])
{
  ...
  int state = 0,ifstarted=0,elsestarted=0,exprstarted=0,varexprstarted=0,boolexprstarted=0,varboolstarted=0;
 ...
 while( (c=file.get()) != EOF )
  {
   ...
   else if(tok == "\"")
   {
    ...
    else if(state == 0 AND (tok == "<" OR tok == ">" OR tok == "!"))
    {
            if(var != "")
          {
              varboolstarted = 1;
     ...
     if(expr!= "")
      {
         ...
         else if(boolexprstarted == 1)
         {
               tokens.push_back("BOOLEXPR:");
               tokens.push_back(expr);
               boolexprstarted=0;
               expr = "";
      ...
      else if(var != "")
      {
          ...
          else if(varboolstarted == 1)
           {
              tokens.push_back("VARBOOLEXPR:");
              tokens.push_back(var);
              varboolstarted=0;
              var = "";
